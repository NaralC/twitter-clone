    ...
    <div class="mt-2 space-y-5">
      <SidebarLeftTab>
        <template v-slot:icon>
          <Icon name="heroicons-solid:home" class="w-8 h-8" />
        </template>
      ...
      <SidebarLeftTab>
        <template v-slot:icon>
          <Icon name="material-symbols:bookmark" class="w-8 h-8" />
        </template>
        <template v-slot:name> Bookmarks </template>
      </SidebarLeftTab>
      <SidebarLeftTab>
        <template v-slot:icon>
          <Icon name="ic:baseline-file-copy" class="w-8 h-8" />
        </template>
        <template v-slot:name> Lists </template>
      </SidebarLeftTab>
      <SidebarLeftTab>
        <template v-slot:icon>
          <Icon name="ic:outline-account-circle" class="w-8 h-8" />
        </template>
        <template v-slot:name> Profile </template>
      </SidebarLeftTab>
      <SidebarLeftTab>
        <template v-slot:icon>
          <Icon name="mdi:dots-horizontal" class="w-8 h-8" />
        </template>
